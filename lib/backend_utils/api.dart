...
class CallApi {
  ...
  Future getData(locationPlacedLat, locationPlacedLng) async {
    http.Response response = await http.get(Uri.parse("https://maps.googleapis.com/maps/api/geocode/json?latlng=$locationPlacedLat,$locationPlacedLng&key=API_KEY"));
